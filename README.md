...
- 插件·Chrome/Edge：2022.10.04.14.43 [下载](ckc.zip) ([Github下载地址，无需注册](https://github.com/easychen/checkchan-dist/raw/master/ckc.zip))
- Docker镜像(云端+远程桌面二合一)：2022.10.04.13.58 [Docker Hub](https://hub.docker.com/repository/docker/easychen/checkchan)
- 文档：2022.10.04.14.43
